...
function Menubar({ className, ...props }: React.ComponentProps<typeof MenubarPrimitive.Root>) {
  return <MenubarPrimitive.Root data-slot="menubar" className={cn('bg-background h-9 rounded-2xl border p-1 flex items-center', className)} {...props} />;
}
...
function MenubarTrigger({ className, ...props }: React.ComponentProps<typeof MenubarPrimitive.Trigger>) {
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn('hover:bg-muted aria-expanded:bg-muted rounded-xl px-2.5 py-1 text-sm font-medium flex items-center outline-hidden select-none', className)}
      {...props}
    />
  );
}
...
function MenubarLabel({
  ...
  return <MenubarPrimitive.Label data-slot="menubar-label" data-inset={inset} className={cn('text-muted-foreground px-3.5 py-2.5 text-xs data-inset:pl-9.5', className)} {...props} />;
}

function MenubarSeparator({ className, ...props }: React.ComponentProps<typeof MenubarPrimitive.Separator>) {
  return <MenubarPrimitive.Separator data-slot="menubar-separator" className={cn('bg-border/50 -mx-1 my-1 h-px', className)} {...props} />;
}

function MenubarShortcut({ className, ...props }: React.ComponentProps<'span'>) {
  return <span data-slot="menubar-shortcut" className={cn('text-muted-foreground group-focus/menubar-item:text-accent-foreground text-xs tracking-widest ml-auto', className)} {...props} />;
}
