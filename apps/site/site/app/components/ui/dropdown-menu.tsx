...
function DropdownMenuLabel({
  ...
  return <DropdownMenuPrimitive.Label data-slot="dropdown-menu-label" data-inset={inset} className={cn('text-muted-foreground px-3 py-2.5 text-xs data-inset:pl-9.5', className)} {...props} />;
}
