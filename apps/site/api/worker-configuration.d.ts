/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: aa9c89fdc8af199c464c5a42a0dfd6f0)
// Runtime types generated with workerd@1.20260305.0 2026-02-26 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MTXManager";
	}
	interface Env {
		DATABASE: Hyperdrive;
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		MTX_MANAGER: DurableObjectNamespace<import("./src/index").MTXManager>;
	}
}
